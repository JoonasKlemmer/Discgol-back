...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        CreateMap<App.DAL.DTO.DiscFromPage, App.BLL.DTO.DiscFromPage>();
        ...
        CreateMap<App.DAL.DTO.DiscsInWishlist, App.BLL.DTO.DiscWithDetails>()
            ...
            .ForMember(dest => dest.PictureUrl, opt => opt.MapFrom(src => src.DiscFromPage!.Websites!.WebsiteName))
            .ForMember(dest => dest.PageUrl, opt => opt.MapFrom(src => src.DiscFromPage!.Websites!.Url));
        CreateMap<App.Domain.DiscFromPage, App.DAL.DTO.DiscFromPage>()
            .ForMember(dest => dest.Discs, opt => opt.Ignore())
            .ForMember(dest => dest.Websites, opt => opt.Ignore())
            .ForMember(dest => dest.PriceValue, opt => opt.Ignore());
        
        CreateMap<App.DAL.DTO.DiscFromPage, Domain.DiscFromPage>()
            .ForMember(dest => dest.DiscId, opt => opt.MapFrom(src => src.DiscId))
